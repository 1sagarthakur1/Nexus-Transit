...
public class JwtTokenValidatorFilter {
	...
	public Claims tokenValidatingforUser(String token) throws TokenException{	
		try {
	...
	public Claims tokenValidatingforTransporter_User(String token) throws TokenException{	
		try {
